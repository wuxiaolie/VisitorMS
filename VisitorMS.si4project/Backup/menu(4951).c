...
void picOfChatRoomFunction(void)
{
	...
	printw("---------------------------------------------------------------------\n");
	printw("																	 \n");
	printw("------------------The chat room function is starting!----------------\n");
	printw("---Please ensure that the server side of the chat room is turned on--\n");
...
void picOfChatRoomEnd(void)
{
	...
	printw("																	 \n");
	printw("---------------------------------------------------------------------\n");
	printw("-----------------The chat room function close seccess!---------------\n");
